          ...
          public void onClick(View v) {
              ...
              if(!cancel)
              {
                  try
                  {
                      ...
                      String url= "http://peon.ml/api/invitetogroup?u="+ URLEncoder.encode(d.getAppMeta("uid"),"UTF-8") +"&ses="+URLEncoder.encode(d.getAppMeta("session"),"UTF-8")+"&gid="+URLEncoder.encode(d.getAppMeta("groupid"),"UTF-8")+"&owner="+ URLEncoder.encode(txtOwnerEmail.getText().toString(),"UTF-8")+"&role="+ URLEncoder.encode(strPos,"UTF-8");
